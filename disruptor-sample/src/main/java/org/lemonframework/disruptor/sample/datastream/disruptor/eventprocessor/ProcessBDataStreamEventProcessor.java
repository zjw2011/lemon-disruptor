...
public class ProcessBDataStreamEventProcessor implements EventHandler<DataStream> {

    private static final Logger LOG = LoggerFactory.getLogger(ProcessBDataStreamEventProcessor.class);
    ...
    public void onEvent(DataStream dataStream, long sequence, boolean endOfBatch)
        ...
        dataStreamService.processDatastream_B(dataStream);
        if (sequence % 10 == 0) {
